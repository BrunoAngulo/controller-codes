@echo off
chcp 65001 >nul
title Organizador de Carpetas Educativas — Otros Primaria

REM ── Si no hay argumentos, mostrar instrucciones ───────────────
if "%~1"=="" (
    echo.
    echo  ============================================================
    echo    ORGANIZADOR DE CARPETAS EDUCATIVAS — OTROS PRIMARIA
    echo  ============================================================
    echo.
    echo  Como usar:
...
python "%~dp0edu_folder_organizer.py" --otros-primaria %*
